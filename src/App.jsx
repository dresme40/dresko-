...
function Onboarding({onDone}){
  ...
  return(
    <div style={{minHeight:"100vh",background:T.white,display:"flex",flexDirection:"column",fontFamily:"-apple-system,'Helvetica Neue',Arial,sans-serif"}}>
      ...
      {/* Contenu */}
      <div style={{flex:1,padding:"0",display:"flex",flexDirection:"column",opacity:vis?1:0,transform:vis?"none":"translateY(16px)",transition:"all 0.22s ease",overflow:"hidden"}}>
        ...
        {step===0&&(
          <div style={{flex:1,padding:"0 32px",display:"flex",flexDirection:"column",justifyContent:"center"}}>
            ...
            <Micro color={T.soft} size={9}>Bienvenue</Micro>
            <h1 style={{fontSize:46,fontWeight:900,color:T.black,lineHeight:1.02,margin:"10px 0 0",letterSpacing:"-0.03em"}}>
              Ton styliste<br/>personnel.
            </h1>
            <div style={{width:28,height:2,background:T.black,margin:"16px 0 8px"}}/>
            <p style={{color:T.mid,fontSize:12,fontStyle:"italic",marginBottom:14,letterSpacing:"0.02em"}}>Quel que soit ton style.</p>
            <p style={{color:T.mid,fontSize:14,lineHeight:1.85,maxWidth:320}}>DRESKO analyse ton dressing, compose tes tenues chaque matin et t'inspire des looks dans tes marques et ton budget.</p>
          </div>
        )}
      ...
      {/* Footer */}
      <div style={{padding:"20px 32px 44px",borderTop:`1px solid ${T.line}`}}>
        ...
        <BtnPrimary onClick={next}>
          {step===4?"📸 Scanner mes premières pièces →":step===0?"Commencer →":"Suivant →"}
        </BtnPrimary>
